...
\begin{multicols}{0}
    ...
    \begin{tikzpicture}
        ...
        \draw[red, line width=0.5mm] (A) to (B);
        \draw[gray] (A) to (C);
        \draw[gray] (A) to (D);
        \draw[red, line width=0.5mm] (B) to (D);
        \draw[red, line width=0.5mm] (C) to (D);
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \draw[red, line width=0.5mm] (A) to (B);
        \draw[red, line width=0.5mm] (A) to (C);
        \draw[gray] (A) to (D);
        \draw[red, line width=0.5mm] (B) to (D);
        \draw[gray] (C) to (D);
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \draw[gray] (A) to (D);
        \draw[red, line width=0.5mm] (C) to (D);
        \draw[red, line width=0.5mm] (D) to (B);
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \draw[red, line width=0.5mm] (A) to (B);
        \draw[red, line width=0.5mm] (A) to (C);
        \draw[red, line width=0.5mm] (A) to (D);
        \draw[gray] (B) to (D);
        \draw[gray] (C) to (D);
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        ...
        \draw[gray] (A) to (C);
        \draw[red, line width=0.5mm] (D) to (B);
        \draw[red, line width=0.5mm] (D) to (C);
        \draw[red, line width=0.5mm] (D) to (A);
    \end{tikzpicture}
